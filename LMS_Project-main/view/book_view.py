...
class BookTab(QWidget):
    ...
    def add_book(self) -> None:
        ...
        try:
            ...
            publisher_id_int = int(publisher) if publisher else None
            ### YOUR CODE ###
            self.controller.add_book(title, author, publisher_id_int, isbn, year_int)
    ...
    def update_book(self) -> None:
        ...
        try:
            ...
            book_year_int = int(book_year) if book_year else None
            book_publisher_id_int = int(book_publisher_id) if book_publisher_id else None

            ### YOUR CODE ###
            self.controller.update_book(book_id, book_title, book_author, book_publisher_id_int, book_isbn, book_year_int)
